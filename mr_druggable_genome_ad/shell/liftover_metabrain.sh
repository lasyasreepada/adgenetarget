...
curl https://hgdownload.soe.ucsc.edu/goldenPath/hg38/liftOver/hg38ToHg19.over.chain.gz -o hg38ToHg19.over.chain.gz

# Convert sum stats file to bed file for crossmap
Rscript ./mr_druggable_genome_pd/R/sumstats2bed_4crossmap.R

# Now run CrossMap
CrossMap.py bed hg38ToHg19.over.chain.gz ${STUDY4LIFTOVER}.txt > ${STUDY4LIFTOVER}_crossmap_hg38ToHg19.txt
